...
function SchoolActions() {
    ...
    const handleChange = (e) => {
        ...
        if (e.target.value === 'true')
            setFilters({ ...filters, attached: true })
                ...
                <div className="flex justify-between items-end w-full  p-2  ">
                    <div className="w-full">
                        <input
                            ...
                            className="w-full p-3 border border-gray-400 h-full rounded"
                    ...
                    <div className="mx-2 w-full">
                        <select
                            ...
                            class="form-select text-gray-600 w-full p-3 rounded border border-gray-400 bg-white"
                        >
                    ...
                    <div className="mx-2 w-full">
                        <select
                            ...
                            class="form-select inline w-full p-3 text-gray-600 rounded border border-gray-400 bg-white"
                        >
