...
function Profile({id}) {
const {data,loading,error} = useQuery(STUDENT,{variables: {id}})
if(error) return <p>Error</p>
if(loading) return <p>Loading</p>

const {name,email,referee1,phone,personal_statement,education1,education2,skills,referee2,voluntary_work,trainings,hobbies} = data?.student
