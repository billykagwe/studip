    ...
    */
    ...
    const submitFormHandler = async (e) => {
        ...
        if (
            ...
            !validateValue(profileInfo.new_password, passwordRegex)
        ) {
            return
        }
    ...
    return (
        <div className="flex flex-row md:flex-col p-3 pt-12  items-between justify-right md:pl-24 ">
            <div className=" shadow-lg bg-white rounded-lg w-auto p-2 md:p-8 md:mt-0 border-t-8 border-teal-500">
                <h2 className="text-gray-700 text-xl font-medium title-font my-10 border-b-2 pb-3">
                    Edit Profile
                </h2>
                ...
                <div className="flex flex-col md:flex-row items-start py-3 border-b-2 pb-3 border-gray-200">
                    <div className=" w-full md:w-1/3 md:mr-3 ">
                        <p className="text-gray-700 tracking-wider mb-2">
                            Contact Info
                        </p>
                        <p className="text-gray-700 tracking-wider text-sm">
                            Having an updated contact information is a great way
                            to ensure companies reach you
                        </p>
                    </div>
                ...
                <div className="flex flex-col md:flex-row mt-8 py-3 items-start border-b-2 pb-3 border-gray-200">
                    <div className=" w-full md:w-1/3 mr-3">
                        ...
                        <p className="text-gray-700 tracking-wider text-sm">
                            Brief overview of your qualifications and skills and
                    ...
                    <div className="w-full md:px-4 md:w-2/3 mt-3 ">
                        <textarea
                            ...
                            value={profileInfo.personal_statement}
                            onChange={onChangeHandler}
                            className="rounded border border-gray-400 focus:outline-none focus:border-green-500 text-base px-4 py-2 h-56 w-full"
                        ></textarea>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row mt-8 py-3 items-start border-b-2 pb-3 border-gray-200">
                    <div className=" w-full md:w-1/3 mr-3">
                        ...
                        <p className="text-gray-700 tracking-wider text-sm">
                            Levels of education starting with the most recent
                            one
                        </p>
                    </div>
                    <div className="w-full md:px-4 md:w-2/3 mt-3 md:mt-0 ">
                        ...
                        <button
                            onClick={() => toggleEducation(true)}
                            className={`inline-block ml-1 mt-4 text-gray-900 ${
                                activeEducation === true && `bg-gray-200`
                            }  p-2 rounded mr-4`}
                        >
                            {' '}
                            secondary{' '}
                        ...
                        <button
                            className={`text-gray-900 ${
                                activeEducation === false && `bg-gray-200`
                            } p-2 rounded`}
                            onClick={() => toggleEducation(false)}
                        >
                            primary
                        </button>
                    </div>
                ...
                <div className="flex flex-col md:flex-row mt-8 py-3 items-start border-b-2 pb-3 border-gray-200">
                    <div className=" w-full md:w-1/3 mr-3">
                        ...
                        <p className="text-gray-700 tracking-wider text-sm">
                            What are the work skills you possess or have
                            developed over time?
                        </p>
                    </div>
                    <div className="w-full md:px-4 md:w-2/3 mt-3 ">
                        <textarea
                            ...
                            onChange={onChangeHandler}
                            placeholder="Skills - (separate skills with comma(,) for better formating)"
                            className="rounded border border-gray-400 focus:outline-none focus:border-green-500 text-base px-4 py-2 h-32 w-full"
                        ></textarea>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row mt-8 py-3 items-start border-b-2 pb-3 border-gray-200">
                    ...
                    <div className="w-full md:px-4 md:w-2/3 mt-3">
                        <textarea
                            name="trainings"
                            value={profileInfo.trainings}
                            onChange={onChangeHandler}
                            placeholder="Trainings - (separate skills with comma(,) for better formating)"
                            className="rounded border border-gray-400 focus:outline-none focus:border-green-500 text-base px-4 py-2 h-32 w-full"
                        ></textarea>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row mt-8 py-3 items-start border-b-2 pb-3 border-gray-200">
                    ...
                    <div className="w-full md:px-4 md:w-2/3 mt-3">
                        <textarea
                            ...
                            onChange={onChangeHandler}
                            placeholder="Hobbies - (separate skills with comma(,) for better formating)"
                            className="rounded border border-gray-400 focus:outline-none focus:border-green-500 text-base px-4 py-2 h-32 w-full"
                        ></textarea>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row mt-8 py-3 items-start border-b-2 pb-3 border-gray-200">
                    <div className=" w-full md:w-1/3 mr-3">
                        ...
                        <p className="text-gray-700 tracking-wider text-sm">
                            What are some of voluntary activities you have
                            engaged in
                        </p>
                    </div>
                    <div className="w-full md:px-4 md:w-2/3 mt-3">
                        <textarea
                            name="voluntary_work"
                            value={profileInfo.voluntary_work}
                            onChange={onChangeHandler}
                            placeholder="Voluntary_work - (separate skills with comma(,) for better formating)"
                            className="rounded border border-gray-400 focus:outline-none focus:border-green-500 text-base px-4 py-2 h-32 w-full"
                        ></textarea>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row mt-8 py-3 items-start border-b-2 pb-3 border-gray-200">
                    <div className=" w-full md:w-1/3 mr-3 mt-3">
                        ...
                        <p className="text-gray-700 tracking-wider text-sm">
                            Include Referees and their contact information as
                            well
                        </p>
                    </div>
                    <div className="w-full px-4 md:w-2/3 relative border border-gray-400 mt-3 py-3">
                        {activeReferee ? (
                            <Referee
                                onRefereeChange={(e) =>
                                    onRefereeChange(e, referee, setReferee)
                                }
                                referee={referee}
                                onSubmit={(e) => e.preventDefault()}
                            />
                            ...
                            <Referee
                                onRefereeChange={(e) =>
                                    onRefereeChange(e, referee2, setReferee2)
                                }
                                referee={referee2}
                                onSubmit={(e) => e.preventDefault()}
                            />
                        ...
                        1 of 3
                        <button
                            onClick={() => toggleReferee(true)}
                            className="inline-block ml-6 mr-4"
                        >
                            {' '}
                            prev{' '}
                        </button>
                        <button onClick={() => toggleReferee(false)}>
                            next
                        </button>
                    </div>
                </div>
                <button
                    ...
                    className="block w-full md:w-1/3 md:mx-auto mt-6 rounded bg-teal-500 text-white px-3 py-2 shadow "
                >
                    Submit
                </button>
            </div>
